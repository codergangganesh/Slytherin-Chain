...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen h-screen w-screen bg-slate-900 flex items-center justify-center p-3 sm:p-5 lg:p-8 relative overflow-hidden font-sans select-none">
      {/* Ambient background styling */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(245,158,11,0.09),rgba(15,23,42,0.85))]" />

      {/* Floating Modern Container (Desktop Full-Size Proportions) */}
      <div className="w-full max-w-[1520px] h-[92vh] max-h-[920px] bg-slate-950/95 border border-slate-800/90 rounded-[36px] shadow-2xl p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6 relative z-10 backdrop-blur-2xl">
        
        {/* ========================================================================= */}
        {/* LEFT COLUMN (5 / 12 Cols): Form, Brand Pill, Role Selector & Inputs      */}
        {/* ========================================================================= */}
        <div className="lg:col-span-5 flex flex-col justify-between p-6 sm:p-8 lg:p-10 bg-gradient-to-b from-slate-900/95 via-slate-900/75 to-amber-950/20 rounded-[28px] border border-slate-800/80 shadow-inner h-full overflow-y-auto">
          
          <div className="space-y-6 sm:space-y-7">
            {/* Top Brand Pill Button (Matching "Crextio" pill in reference) */}
            <div className="flex items-center justify-between">
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-slate-800/80 border border-slate-700/70 text-slate-200 text-xs sm:text-sm font-bold tracking-wide shadow-sm">
                <Shield className="w-4 h-4 text-amber-400" />
                <span>SentinelChain</span>
              </div>
              <span className="text-[11px] font-mono text-slate-500 uppercase tracking-wider font-semibold">v1.0 SOC</span>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950/90 border border-slate-800 rounded-2xl pl-11 pr-4 py-3 text-xs sm:text-sm text-white placeholder-slate-600 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500/30 transition-all font-medium shadow-sm"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950/90 border border-slate-800 rounded-2xl pl-11 pr-11 py-3 text-xs sm:text-sm text-white placeholder-slate-600 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500/30 transition-all font-medium shadow-sm"
                    required
                  />
                  <button
                    type="button"
            ...
            <div className="space-y-2 pt-2">
              <span className="text-[10px] sm:text-[11px] font-bold text-slate-500 uppercase tracking-wider block text-center">
          ...
          <div className="pt-4 mt-6 border-t border-slate-800/60 flex items-center justify-between text-xs text-slate-500">
            <span>
        ...
        {/* ========================================================================= */}
        {/* RIGHT COLUMN (7 / 12 Cols): Image Hero Card with Floating Widgets        */}
        {/* ========================================================================= */}
        <div className="lg:col-span-7 relative rounded-[28px] overflow-hidden h-full flex flex-col justify-between p-6 sm:p-8 lg:p-10 shadow-2xl border border-slate-800/80 bg-slate-950">
          ...
          <div className="relative z-10 self-center w-full max-w-lg my-auto">
            <div className="p-4 sm:p-5 bg-slate-900/85 border border-white/15 rounded-3xl backdrop-blur-xl shadow-2xl space-y-3">
              ...
              <div className="grid grid-cols-4 gap-2 text-xs text-center font-mono">
                <div className="p-2 bg-slate-950/80 rounded-2xl border border-slate-800 text-slate-300">
          ...
          <div className="relative z-10 p-4 sm:p-5 bg-slate-900/90 border border-slate-700/80 rounded-3xl backdrop-blur-xl shadow-2xl flex items-center justify-between">
